...
abstract contract Staking is ReentrancyGuard, IStaking {
    ...
    constructor(
        ...
        require(_stakingToken != address(0), "address 0");
        require(
    ...
    {
        _numerator = stakingConditions[nextConditionId - 1]
            .rewardRatioNumerator;
        _denominator = stakingConditions[nextConditionId - 1]
    ...
    function _stake(uint256 _amount) internal virtual {
        ...
        if (stakers[_stakeMsgSender()].amountStaked > 0) {
            ...
            stakers[_stakeMsgSender()].timeOfLastUpdate = uint80(
                block.timestamp
            );
